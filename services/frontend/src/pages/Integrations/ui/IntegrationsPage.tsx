...
import type { AISettings } from "../../../features/integrations/hooks/useIntegrations";
  ...
  const available = [
    {
      ...
      icon: "phone_in_talk",
      color: "blue",
      desc: "Sync call recordings and metadata from Sipuni.",
    },
    {
      id: "amocrm",
      name: "AmoCRM",
      ...
      icon: "hub",
      color: "orange",
      desc: "Sync analysis results back to AmoCRM leads.",
    },
    {
      id: "openai",
      name: "OpenAI",
      ...
      icon: "psychology",
      color: "emerald",
      desc: "Use OpenAI Whisper and GPT models for analysis.",
    },
    {
      id: "groq",
      name: "Groq",
      ...
      icon: "bolt",
      color: "yellow",
      desc: "High-speed Whisper STT provider.",
    },
    {
      id: "gemini",
      name: "Google Gemini",
      ...
      icon: "cloud",
      color: "blue",
      desc: "Google Gemini STT and LLM provider.",
    },
    {
      id: "deepgram",
      name: "Deepgram",
      ...
      icon: "graphic_eq",
      color: "purple",
      desc: "Enterprise-grade STT provider.",
    },
    {
      id: "elevenlabs",
      name: "ElevenLabs",
      ...
      color: "purple",
      desc: "High-quality STT with diarization.",
    },
    {
      id: "soniox",
      name: "Soniox",
      ...
      icon: "settings_voice",
      color: "blue",
      desc: "Accurate and fast speech recognition.",
    },
    {
      id: "telegram",
      name: t("integrations.telegram_name"),
      type: t("integrations.notifications"),
      icon: "send",
      color: "blue",
      desc: t("integrations.telegram_desc"),
    },
    {
      id: "slack",
      name: t("integrations.slack_name"),
      type: t("integrations.communication"),
      icon: "chat_bubble",
      color: "purple",
      desc: t("integrations.slack_desc"),
    },
  ];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {integrations
              ...
              .map((i) => (
                <div
                  key={i.id}
                  className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-6 shadow-sm relative overflow-hidden group"
                >
                  ...
                  <div className="flex items-start gap-4 mb-6">
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        <span
                          className={`size-2 rounded-full ${i.status_message ? "bg-red-500" : "bg-green-500"}`}
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {available.map((app) => (
              <div
                key={app.id}
                className={`bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-6 shadow-sm transition-all flex flex-col ${isConnected(app.id) ? "opacity-50 grayscale" : "hover:border-primary/30"}`}
              >
                <div className="flex items-start gap-4 mb-4">
                  <div
                    className={`size-12 rounded-lg bg-slate-50 dark:bg-slate-800 flex items-center justify-center`}
                  >
                    <span
                ...
                >
                  ...
                  {isConnected(app.id)
                    ? t("integrations.connected_status")
                    : t("integrations.connect_now")}
                </button>
              </div>
            ))}
          </div>
