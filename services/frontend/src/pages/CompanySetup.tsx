...
const CompanySetup: React.FC = () => {
  ...
  return (
    <div className="font-display bg-background-light dark:bg-background-dark text-neutral-800 dark:text-neutral-100 min-h-screen flex flex-col antialiased selection:bg-primary/30 selection:text-primary">
        ...
        <div className="w-full max-w-xl z-10">
          ...
          <div className="bg-white dark:bg-neutral-900 shadow-xl shadow-neutral-200/50 dark:shadow-none border border-neutral-100 dark:border-neutral-800 rounded-xl p-8 sm:p-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="pt-6 flex items-center justify-between gap-4">
                <button
                  className="px-6 py-3 rounded-lg border border-neutral-200 dark:border-neutral-700 text-neutral-700 dark:text-neutral-300 font-medium hover:bg-neutral-50 dark:hover:bg-neutral-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-neutral-200 transition-colors"
                  type="button"
                  onClick={() => navigate(-1)}
                >
                  Back
                ...
                <button
                  className="flex-1 px-6 py-3 rounded-lg bg-primary text-white font-medium hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary shadow-lg shadow-primary/30 hover:shadow-primary/40 transition-all flex justify-center items-center gap-2 group disabled:opacity-50"
                  type="submit"
                  disabled={loading}
                >
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-neutral-500 dark:text-neutral-400">
              ...
              <a className="text-primary hover:text-primary/80 hover:underline" href="#">Terms of Service</a>{' '}
              and{' '}
      ...
      <div className="hidden xl:block fixed top-0 right-0 w-1/3 h-full z-0">
        <div className="absolute inset-0 bg-gradient-to-bl from-primary/10 to-transparent dark:from-primary/20"></div>
        <div className="h-full w-full opacity-30 dark:opacity-20" style={{ backgroundImage: 'radial-gradient(#2463eb 1px, transparent 1px)', backgroundSize: '32px 32px' }}></div>
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 bg-white dark:bg-neutral-800 rounded-xl shadow-2xl p-6 border border-neutral-100 dark:border-neutral-700 transform rotate-3 hover:rotate-0 transition-transform duration-500 cursor-default">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 rounded-full bg-green-100 dark:bg-green-900/30 flex items-center justify-center text-green-600 dark:text-green-400">
              <span className="material-icons">trending_up</span>
            </div>
            <div>
              <h4 className="text-sm font-bold text-neutral-900 dark:text-white">AI Insight Ready</h4>
              <p className="text-xs text-neutral-500">Pipeline forecast updated</p>
            </div>
          </div>
          <div className="h-24 w-full bg-neutral-50 dark:bg-neutral-900 rounded-lg relative overflow-hidden flex items-end px-2 pb-2 gap-1">
            <div className="w-1/5 bg-primary/20 h-1/3 rounded-t"></div>
            <div className="w-1/5 bg-primary/40 h-1/2 rounded-t"></div>
            <div className="w-1/5 bg-primary/60 h-2/3 rounded-t"></div>
            <div className="w-1/5 bg-primary/80 h-3/4 rounded-t"></div>
