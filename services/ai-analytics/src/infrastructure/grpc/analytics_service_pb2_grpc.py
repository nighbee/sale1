...
class AnalyticsServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetAnalysis = channel.unary_unary(
                '/analytics.AnalyticsService/GetAnalysis',
                request_serializer=analytics__service__pb2.AnalysisRequest.SerializeToString,
                response_deserializer=analytics__service__pb2.AnalysisResponse.FromString,
...
def add_AnalyticsServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetAnalysis': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=analytics__service__pb2.AnalysisRequest.FromString,
                    response_serializer=analytics__service__pb2.AnalysisResponse.SerializeToString,
            ),
    }
...
class AnalyticsService(object):
    ...
    def GetAnalysis(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/analytics.AnalyticsService/GetAnalysis',
            analytics__service__pb2.AnalysisRequest.SerializeToString,
            analytics__service__pb2.AnalysisResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
