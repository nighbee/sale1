...
class TestDB(unittest.TestCase):
    def test_ensure_manager_user_exists_already_exists(self):
        ...
        result = _ensure_manager_user_exists(cur, manager_id, manager_name)
    ...
    def test_ensure_manager_user_exists_creates_new(self):
        ...
        self.assertEqual(cur.execute.call_count, 2) # SELECT, INSERT user
        ...
        # params[2] should be the password hash
